...
Partial Class F_MatHang
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(F_MatHang))
        TxtMaMH = New TextBox()
        Label5 = New Label()
        BtThoat = New Button()
        BtCuoi = New Button()
        ...
        ' TxtMaMH
        ' 
        TxtMaMH.Location = New Point(285, 91)
        TxtMaMH.Name = "TxtMaMH"
        TxtMaMH.Size = New Size(372, 31)
        TxtMaMH.TabIndex = 57
        ' 
        ' Label5
        ' 
        ...
        ' TxtSoLuong
        ' 
        TxtSoLuong.Location = New Point(285, 239)
        TxtSoLuong.Name = "TxtSoLuong"
        TxtSoLuong.Size = New Size(372, 31)
        TxtSoLuong.TabIndex = 44
        ' 
        ' TxtGia
        ' 
        TxtGia.Location = New Point(285, 186)
        TxtGia.Name = "TxtGia"
        TxtGia.Size = New Size(372, 31)
        TxtGia.TabIndex = 43
        ' 
        ' TxtTenMH
        ' 
        TxtTenMH.Location = New Point(285, 138)
        TxtTenMH.Name = "TxtTenMH"
        TxtTenMH.Size = New Size(372, 31)
        TxtTenMH.TabIndex = 42
        ' 
        ' Label4
        ' 
        Label4.AutoSize = True
        Label4.Location = New Point(160, 192)
        Label4.Name = "Label4"
        ...
        Label3.Location = New Point(160, 245)
        Label3.Name = "Label3"
        ...
        Label2.Location = New Point(160, 141)
        Label2.Name = "Label2"
